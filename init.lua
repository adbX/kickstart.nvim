...
do
  ...
  -- vim.cmd.colorscheme 'tokyonight-storm' -- overridden by custom/plugins/colorschemes.lua (gruvbox-material)
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'yaml', 'latex'}
